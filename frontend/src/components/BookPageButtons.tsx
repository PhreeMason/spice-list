...
const BookPageButtons = ({ bookId }: { bookId: number}) => {
    ...
    const exclusiveShelf = createExclusiveShelfName(userBook?.exclusive_shelf as ExclusiveSelf);
    ...
    return (
        <View className="flex-row">
            <CustomButton
                ...
                leftIcon={exclusiveShelf ? <Feather style={{ marginRight: 2 }} name="check" size={24} color="green" /> : null}
